...
public final class BiomeMobScrollWidget implements ISlottedRecipeWidget, IJeiInputHandler {

    private static final int SCROLLBAR_WIDTH = 14;
    private static final int MIN_SCROLL_MARKER_HEIGHT = 14;

    private final BiomeMobRecipe recipe;
    private final ItemStack focusedDropStack;
    ...
    public BiomeMobScrollWidget(BiomeMobRecipe recipe, ItemStack focusedDropStack, int x, int y, int width, int height, List<IRecipeSlotDrawable> contentSlots) {
        this.recipe = recipe;
        this.focusedDropStack = focusedDropStack.copy();
        this.contentSlots = new ArrayList<>(contentSlots);
        this.height = height;
        this.area = new ImmutableRect2i(x, y, width, height);
        this.contentsArea = new ImmutableRect2i(0, 0, width - BiomeMobRecipeCategory.getScrollbarWidth(), height);
        ...
        this.contentHeight = BiomeMobRecipeCategory.getTotalContentHeight(recipe, focusedDropStack);
        this.slotPlacements = BiomeMobRecipeCategory.getSlotPlacements(recipe, focusedDropStack);
    }
    ...
    public void drawWidget(GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        BiomeMobRecipeCategory.drawScrollableContents(recipe, focusedDropStack, guiGraphics, 0, 0);
    ...
    private void drawSlots(GuiGraphics guiGraphics) {
        ...
        for (int index = 0; index < slotCount; index++) {
            ...
            BiomeMobRecipeCategory.SlotPlacement placement = slotPlacements.get(index);
